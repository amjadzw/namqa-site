...
window.__NAMQA_SOLUTIONS_SVG__ = {
  ...
  <svg viewBox="0 0 320 260" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Programme de fidélité">
    <defs>
      <linearGradient id="sol-card-g" x1="0" y1="0" x2="1" y2="1">
        ...
        <stop offset="100%" stop-color="#2E2E80"/>
      </linearGradient>
      <linearGradient id="sol-cup-g" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stop-color="#FEFDF7"/>
        <stop offset="100%" stop-color="#E6E6F2"/>
      </linearGradient>
    </defs>
    <!-- Saucer -->
    <ellipse cx="130" cy="150" rx="90" ry="16" fill="#2E2E80" opacity="0.12"/>
    <ellipse cx="130" cy="146" rx="82" ry="12" fill="#E6E6F2"/>
    <!-- Cup -->
    <path d="M70 70 L70 130 Q70 146 100 146 L160 146 Q190 146 190 130 L190 70 Z" fill="url(#sol-cup-g)" stroke="#2E2E80" stroke-width="2"/>
    <path d="M190 85 Q220 85 220 105 Q220 125 190 125" fill="none" stroke="#2E2E80" stroke-width="2.5"/>
    <!-- Latte art heart -->
    <ellipse cx="130" cy="95" rx="50" ry="10" fill="#C9C9E8"/>
    <path d="M120 88 Q115 80 125 80 Q130 80 130 86 Q130 80 135 80 Q145 80 140 88 Q135 96 130 100 Q125 96 120 88 Z" fill="#FEFDF7"/>
    <!-- Steam -->
    <path d="M110 50 Q115 42 110 34 Q105 26 110 18" fill="none" stroke="#4F4FC9" stroke-width="2" stroke-linecap="round" opacity="0.6"/>
    <path d="M130 50 Q135 42 130 34 Q125 26 130 18" fill="none" stroke="#4F4FC9" stroke-width="2" stroke-linecap="round" opacity="0.6"/>
    <path d="M150 50 Q155 42 150 34 Q145 26 150 18" fill="none" stroke="#4F4FC9" stroke-width="2" stroke-linecap="round" opacity="0.6"/>
    ...
    <!-- Small QR -->
    <rect x="45" y="180" width="58" height="58" rx="8" fill="#FEFDF7" stroke="#2E2E80" stroke-width="2"/>
    <g fill="#121240">
    ...
    <g transform="translate(82 135) rotate(-12)">
      <rect x="-22" y="-12" width="44" height="24" rx="12" fill="#4F4FC9"/>
  ...
  <svg viewBox="0 0 320 260" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Cartes prépayées cashless">
    ...
    <!-- Plate shadow -->
    <ellipse cx="160" cy="220" rx="120" ry="14" fill="#2E2E80" opacity="0.12"/>
    <!-- Plate -->
    <ellipse cx="160" cy="212" rx="114" ry="12" fill="#E6E6F2"/>
    <ellipse cx="160" cy="208" rx="110" ry="10" fill="#FEFDF7" stroke="#2E2E80" stroke-width="1.5"/>

    <!-- Dome (lifted) -->
    <g transform="translate(0 -35)">
      <path d="M60 178 Q160 70 260 178 Z" fill="url(#sol-dome-g)" stroke="#2E2E80" stroke-width="2"/>
      <path d="M60 178 Q160 70 260 178" fill="none" stroke="#2E2E80" stroke-width="2"/>
      <circle cx="160" cy="70" r="6" fill="#2E2E80"/>
      <!-- Sparkles -->
      <g fill="#4F4FC9">
    ...
    <circle cx="160" cy="189" r="22" fill="#FEFDF7"/>
    <text x="160" y="196" fill="#2E2E80" font-family="Space Grotesk, sans-serif" font-size="22" font-weight="800" text-anchor="middle">€</text>
  ...
  <svg viewBox="0 0 320 260" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Avis client">
    ...
    <g transform="translate(60 30)">
      <rect x="0" y="0" width="140" height="220" rx="22" fill="#121240"/>
      <rect x="6" y="18" width="128" height="184" rx="10" fill="url(#sol-phone-g)"/>
      <circle cx="70" cy="10" r="3" fill="#FEFDF7" opacity="0.4"/>

      <!-- Review card 1 -->
      <g transform="translate(14 32)">
        <rect x="0" y="0" width="112" height="64" rx="8" fill="#FEFDF7" stroke="#E6E6F2" stroke-width="1"/>
        <circle cx="14" cy="14" r="8" fill="#4F4FC9"/>
        <text x="28" y="17" fill="#121240" font-family="Inter, sans-serif" font-size="9" font-weight="700">Louise D.</text>
        <g fill="#4F4FC9" transform="translate(28 22)">
          <text x="0" y="9" font-size="10" font-weight="700">★★★★★</text>
        </g>
        <rect x="6" y="40" width="100" height="4" rx="2" fill="#E6E6F2"/>
        <rect x="6" y="48" width="84" height="4" rx="2" fill="#E6E6F2"/>
        <rect x="6" y="56" width="70" height="4" rx="2" fill="#E6E6F2"/>
      </g>

      <!-- Review card 2 (half-hidden) -->
      <g transform="translate(14 104)" opacity="0.85">
        <rect x="0" y="0" width="112" height="48" rx="8" fill="#FEFDF7" stroke="#E6E6F2" stroke-width="1"/>
        <circle cx="14" cy="14" r="8" fill="#6A6AD1"/>
        <text x="28" y="17" fill="#121240" font-family="Inter, sans-serif" font-size="9" font-weight="700">Marco R.</text>
        <g fill="#4F4FC9" transform="translate(28 22)">
          <text x="0" y="9" font-size="10" font-weight="700">★★★★★</text>
        </g>
        <rect x="6" y="38" width="90" height="4" rx="2" fill="#E6E6F2"/>
      </g>

      <!-- Big rating chip -->
      <g transform="translate(14 160)">
        <rect x="0" y="0" width="112" height="34" rx="8" fill="#4F4FC9"/>
  ...
  <svg viewBox="0 0 320 260" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Base de données clients">
    ...
    <!-- Laptop base -->
    <path d="M50 200 L270 200 L286 220 L34 220 Z" fill="#2E2E80"/>
    <path d="M50 200 L270 200 L286 220 L34 220 Z" fill="#4F4FC9" opacity="0.3"/>
    <rect x="140" y="200" width="40" height="4" rx="2" fill="#1F1F5E"/>

    <!-- Laptop screen -->
    <rect x="60" y="50" width="200" height="150" rx="6" fill="#121240"/>
    <rect x="66" y="56" width="188" height="138" rx="4" fill="url(#sol-lap-g)"/>

    <!-- Dashboard: avatar chips row -->
    <g transform="translate(74 66)">
      <rect x="0" y="0" width="80" height="30" rx="6" fill="#FEFDF7" stroke="#E6E6F2" stroke-width="1"/>
      <circle cx="14" cy="15" r="8" fill="#4F4FC9"/>
      <rect x="26" y="8" width="40" height="5" rx="2" fill="#121240"/>
      <rect x="26" y="17" width="28" height="4" rx="2" fill="#C9C9E8"/>
    </g>

    <!-- Bar chart -->
    <g transform="translate(162 66)">
      <rect x="0" y="0" width="88" height="58" rx="6" fill="#FEFDF7" stroke="#E6E6F2" stroke-width="1"/>
      <rect x="8" y="36" width="10" height="14" rx="1" fill="#6A6AD1"/>
      <rect x="22" y="24" width="10" height="26" rx="1" fill="#4F4FC9"/>
      <rect x="36" y="30" width="10" height="20" rx="1" fill="#6A6AD1"/>
      <rect x="50" y="14" width="10" height="36" rx="1" fill="#4F4FC9"/>
      <rect x="64" y="22" width="10" height="28" rx="1" fill="#6A6AD1"/>
    </g>

    <!-- Line chart -->
    <g transform="translate(74 102)">
      <rect x="0" y="0" width="176" height="82" rx="6" fill="#FEFDF7" stroke="#E6E6F2" stroke-width="1"/>
      <polyline points="10,60 40,50 70,54 100,30 130,38 160,18" fill="none" stroke="#4F4FC9" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
      <circle cx="160" cy="18" r="3.5" fill="#4F4FC9"/>
      <!-- Axis lines -->
      <line x1="10" y1="70" x2="166" y2="70" stroke="#E6E6F2" stroke-width="1"/>
      <!-- Donut -->
      <g transform="translate(18 8)">
        <circle cx="14" cy="14" r="10" fill="none" stroke="#E6E6F2" stroke-width="4"/>
        <circle cx="14" cy="14" r="10" fill="none" stroke="#4F4FC9" stroke-width="4" stroke-dasharray="48 80" transform="rotate(-90 14 14)"/>
      </g>
      <text x="50" y="14" fill="#121240" font-family="Inter, sans-serif" font-size="8" font-weight="700">+32%</text>
      <text x="50" y="24" fill="#6A6AD1" font-family="Inter, sans-serif" font-size="7">Fréquence</text>
    </g>

    <!-- Floating data dots -->
    <g fill="#4F4FC9" opacity="0.5">
